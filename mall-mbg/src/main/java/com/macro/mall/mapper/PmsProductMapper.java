...
import static com.macro.mall.mapper.PmsProductDynamicSqlSupport.*;
...
@Mapper
public interface PmsProductMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<PmsProduct>, CommonUpdateMapper {
    ...
    default int insertSelective(PmsProduct row) {
        return MyBatis3Utils.insert(this::insert, row, pmsProduct, c ->
            ...
            .map(recommandStatus).toPropertyWhenPresent("recommandStatus", row::getRecommandStatus)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(PmsProduct row, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(row::getId)
                ...
                .set(recommandStatus).equalTo(row::getRecommandStatus)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(PmsProduct row, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(row::getId)
                ...
                .set(recommandStatus).equalToWhenPresent(row::getRecommandStatus)
