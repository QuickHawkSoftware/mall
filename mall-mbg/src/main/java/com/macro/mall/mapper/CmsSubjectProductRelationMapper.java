...
import static com.macro.mall.mapper.CmsSubjectProductRelationDynamicSqlSupport.*;
...
@Mapper
public interface CmsSubjectProductRelationMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<CmsSubjectProductRelation>, CommonUpdateMapper {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insert(CmsSubjectProductRelation row) {
        return MyBatis3Utils.insert(this::insert, row, cmsSubjectProductRelation, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertMultiple(Collection<CmsSubjectProductRelation> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, cmsSubjectProductRelation, c ->
            c.map(id).toProperty("id")
            .map(subjectId).toProperty("subjectId")
            .map(productId).toProperty("productId")
        );
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective(CmsSubjectProductRelation row) {
        return MyBatis3Utils.insert(this::insert, row, cmsSubjectProductRelation, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns(CmsSubjectProductRelation row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(CmsSubjectProductRelation row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey(CmsSubjectProductRelation row) {
        return update(c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKeySelective(CmsSubjectProductRelation row) {
        return update(c ->
